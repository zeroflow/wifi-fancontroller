...
:::caution[DS18B20 example still coming]
The module and its config compile and validate cleanly, but the end-to-end read of a physical DS18B20 over this bridge has not been bench-tested yet. A verified DS18B20 example is on the way.
:::
